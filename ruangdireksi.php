...
<head>
    ...
    <title>Ruang Direksi - Sistem Kinerja Office Boy - BPRS HIK MCI Yogyakarta</title>
            ...
            <main class="content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detail Ruang Direksi</li>
                    </ol>
                </nav>
                <?php
                if (isset($_GET['page'])) {
                ...
                <div class="container">
                        <div class="card">
                            <div class="card-body" id="resultsContent">
                                <h2><i class="fa fa-book"></i> Detail Ruang Direksi</h2>
